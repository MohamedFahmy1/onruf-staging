...
const PackageCheckoutModal = ({ isModalOpen, setIsModalOpen }) => {
  const { locale, push } = useRouter()

  const handleNavigate = () => {
    push(`/settings/packages`, undefined, { locale: locale })
  }
      ...
      content = (
        <>
          ...
          <p style={{ fontSize: "26px", marginBlock: "25px" }}>
            {pathOr("", [locale, "Packages", "PackageSubscribed"], t)}
          </p>
          <button
            className="btn-main"
          ...
          >
            {pathOr("", [locale, "Packages", "ManagePackages"], t)}
          </button>
          <p
            className="pointer"
