...
const WalletCardModal = ({ isCardModalOpen, setIsCardModalOpen, handleAccept, selectedPayment }) => {
  const { locale } = useRouter()
  const { data: cardList, isLoading, fetchData } = useFetch(`/BankTransfersList?creditCards=true`)

  const [selectedCard, setSelectedCard] = useState(selectedPayment)
